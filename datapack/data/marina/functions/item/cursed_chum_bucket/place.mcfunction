...
execute if score temp_0 mar.dummy matches 25.. run function marina:item/cursed_chum_bucket/break
setblock -30000000 0 24576 minecraft:yellow_shulker_box
particle minecraft:dust 0.9 1 0 1 ~ ~ ~ 0.2 0.2 0.2 0.05 30
...
summon minecraft:marker ~ ~ ~ {Tags:[global.ignore,mar.cursed_chum,mar.chum]}