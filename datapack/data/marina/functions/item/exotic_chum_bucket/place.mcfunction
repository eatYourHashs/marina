...
execute if score temp_0 mar.dummy matches 25.. run function marina:item/exotic_chum_bucket/break
setblock -30000000 0 24576 minecraft:yellow_shulker_box
particle item tropical_fish ~ ~ ~ 0.2 0.2 0.2 0.05 30
...
summon minecraft:marker ~ ~ ~ {Tags:[global.ignore,mar.exotic_chum,mar.chum]}