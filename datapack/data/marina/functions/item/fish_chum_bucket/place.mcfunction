...
execute if score temp_0 mar.dummy matches 25.. run function marina:item/fish_chum_bucket/break
setblock -30000000 0 24576 minecraft:yellow_shulker_box
particle item salmon ~ ~ ~ 0.2 0.2 0.2 0.05 30
...
summon minecraft:marker ~ ~ ~ {Tags:[global.ignore,mar.fish_chum,mar.chum]}